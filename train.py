...
from prompt_mutate import optimize_prompts, optimize_prompts_with_feedback
...
OUTPUT_BASE_DIR = os.path.join(BASE_DIR, "infer_3b_full_context")

initial_prompt_path = os.path.join(BASE_DIR, "origin_prompts.jsonl")
...
# ============================================================================
# FEEDBACK-GUIDED MUTATION SETTINGS
# ============================================================================
USE_FEEDBACK_GUIDED_MUTATION = True  # Set to True to enable Level 1 feedback-guided mutation
MUTATION_SELECTION_STRATEGY = "top_k"  # Options: "top_k", "proportional", "all"

for gen in range(N_GENERATIONS):
    print("\n" + "=" * 60)
    print(f"GENERATION {gen + 1}/{N_GENERATIONS}")
    if USE_FEEDBACK_GUIDED_MUTATION:
        print("[MODE] Feedback-Guided Mutation ENABLED")
    print("=" * 60)
    ...
    # Now with feedback collection for mutation
    ...
    feedback_file_path = evaluate_and_select_best_prompts(
        ...
        collect_feedback=USE_FEEDBACK_GUIDED_MUTATION  # Enable feedback collection
    )
    
    if feedback_file_path:
        print(f"[Step 2] Feedback collected and saved to: {feedback_file_path}")
    ...
    #     if USE_FEEDBACK_GUIDED_MUTATION and feedback_file_path:
    #         # Use feedback-guided mutation
    #         print("[Step 3] Using FEEDBACK-GUIDED mutation")
    #         optimize_prompts_with_feedback(
    #             feedback_file=feedback_file_path,
    #             best_prompts_file=best_prompt_output_path,
    ...
    #             selection_strategy=MUTATION_SELECTION_STRATEGY
    #         )
    #     else:
    #         # Use standard mutation (fallback)
    #         print("[Step 3] Using STANDARD mutation (no feedback)")
    #         optimize_prompts(
